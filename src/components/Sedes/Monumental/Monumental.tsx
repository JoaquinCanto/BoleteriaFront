...
import FotoMonumental from './Monumental.jpg'
import AccMonumental from './Accesos.png'

function Monumental() {
	return (
	<>
        <div className='Sede1'>
            <h2>Mâs Monumental</h2>
            ...
            <h3>Calles</h3>
            <p>El recinto deportivo está ubicado en la intersección de las avenidas Figueroa Alcorta y Udaondo del barrio de Belgrano, Buenos Aires, Argentina. <br />
                Las líneas de colectivo que llegan al estadio Mas Monumental son las siguientes: 15, 29, 37, 42, 57, 107, 130, 152 y 160.</p>
            <h3>Accesos</h3>
            <img src={AccMonumental} alt="" />
        </div>
	</>
	)
}
