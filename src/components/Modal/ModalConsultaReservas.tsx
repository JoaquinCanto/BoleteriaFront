			...
			<div className="formRecital">
				<form>
					...
					<div>
						...
						<input className="campo" type="number" placeholder="cantidad" {...register("cantidad", { required: "Este campo es requerido.", min: { value: 0, message: "No pueden ser negativas." }, max: { value: 84000, message: "No pueden superar la cantidad permitida." } })} />
